...
//    };
   $scope.edit = function () {
    ...
    $scope.LoadNhasx = function () {
        $http({
            method: 'GET',
            headers: { "Authorization": 'Bearer ' + _user.token },
            url: current_url + '/api/NhaSanXuat/get-all-data/20',
        }).then(function (response) {
            $scope.listNhasx = response.data;
            makeScript('js/main.js')
        });
    };
...
app.controller("HoaDonNhapCtrl", function ($scope, $http){ //Bộ điều khiển AngularJS điều khiển các ứng dụng:
   ...
   $scope.LoadHoaDonNhap = function () {
    $http({
        method: 'GET',
        headers: { "Authorization": 'Bearer ' + _user.token },
        url: current_url + '/api/HoaDonNhap/hoadonnhap_all/20',
    }).then(function (response) {
        $scope.listHoaDonNhap = response.data;
        makeScript('js/main.js')
    });
    };
    $scope.LoadChiTietById = function () { 
		var key = 'id';
		var value = window.location.search.substring(window.location.search.indexOf(key)+key.length+1);		 
        $http({
            method: 'GET', 
            headers: { "Authorization": 'Bearer ' + _user.token },
            url: current_url + '/api/HoaDonNhap/hoadonnhap_chitiet/'+value,
        }).then(function (response) { 
            $scope.chitiethoadon = response.data;
			makeScript('js/main.js')
        });
    };  
    $scope.LoadHoaDonById = function () { 
		var key = 'id';
		var value = window.location.search.substring(window.location.search.indexOf(key)+key.length+1);		 
        $http({
            method: 'GET', 
            headers: { "Authorization": 'Bearer ' + _user.token },
            url: current_url + '/api/HoaDonNhap/hoadonnhap_get/'+value,
        }).then(function (response) { 
            $scope.hoadon = response.data;
			makeScript('js/main.js')
        });
    };  
    $scope.LoadChiTietById();
    $scope.LoadHoaDonById();
...
app.controller("DonHangCtrl", function ($scope, $http){ //Bộ điều khiển AngularJS điều khiển các ứng dụng:
    ...
    $scope.addHoaDon = function (id) {
        $http({
            method: 'GET',
            headers: { "Authorization": 'Bearer ' + _user.token },
            url: current_url + '/api/DonHang/get_donHang_byId/' + id,
        }).then(function (listdonhang) {
            $http({
                method: 'GET',
                headers: { "Authorization": 'Bearer ' + _user.token },
                url: current_url + '/api/DonHang/get_ChiTiet_byId/' + id,
            }).then(function (chitiet) {
                let model = {
                    // maLV: $scope.maDanhMuc,
                    maDonHang: listdonhang.data.maDonHang,
                    maKhachHang:  listdonhang.data.maKhachHang,
                    ngayBan:  listdonhang.data.ngayDat,
                    listchitietdonhang:  chitiet.data
                }
               $http({
                   method: 'POST', 
                   headers: { "Authorization": 'Bearer ' + _user.token },
                   data: model, 
                   url: current_url + '/api/DonHang/add_hoadonban'
               }).then(function (response) {	
    ...
    $scope.LoadKhachHangById = function () { 
		var key = 'id';
		var value = window.location.search.substring(window.location.search.indexOf(key)+key.length+1);		 
        $http({
            method: 'GET', 
            headers: { "Authorization": 'Bearer ' + _user.token },
            url: current_url + '/api/DonHang/get-khachhang-by-id/'+value,
        }).then(function (response) { 
    ...
    $scope.LoadChiTietById = function () { 
        ...
        $http({
            method: 'GET', 
            headers: { "Authorization": 'Bearer ' + _user.token },
            url: current_url + '/api/DonHang/get-chitiet-by-id/'+value,
        }).then(function (response) { 
   ...
   $http({
    ...
    $scope.DonHang = function () {
        $http({
            method: 'GET',
            headers: { "Authorization": 'Bearer ' + _user.token },
            url: current_url + '/api/DonHang/donhang/10',
        }).then(function (response) {
...
app.controller("HoaDonBanCtrl", function ($scope, $http){ //Bộ điều khiển AngularJS điều khiển các ứng dụng:
    ...
    $scope.LoadChiTietById = function () { 
        ...
        $http({
            method: 'GET', 
            headers: { "Authorization": 'Bearer ' + _user.token },
            url: current_url + '/api/HoaDonBan/get-chitiet/'+value,
        }).then(function (response) { 
            $scope.chitiethoadon = response.data;
			makeScript('js/main.js')
        });
    ...
    $scope.LoadChiTietById();
     ...
     $scope.LoadHoaDonById = function () { 
        ...
        $http({
            method: 'GET', 
            headers: { "Authorization": 'Bearer ' + _user.token },
            url: current_url + '/api/HoaDonBan/get-hoadon/'+value,
        }).then(function (response) { 
            $scope.hoadon = response.data;
			makeScript('js/main.js')
        });
   ...
   $http({
    ...
    $http({
        method: 'GET',
        headers: { "Authorization": 'Bearer ' + _user.token },
        url: current_url + '/api/HoaDonBan/get-data-hoadon/15',
    }).then(function (response) {
        $scope.listHoaDon = response.data;
        makeScript('js/main.js')
    });
